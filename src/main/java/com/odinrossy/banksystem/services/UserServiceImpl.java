...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public User getUserByIdPassport(String idPassport) {
    ...
    @Override
    public User update(String idPassport, User user) throws RuntimeException {
        checkUser(user);
    ...
    @Override
    public void delete(String idPassport) {
        getUserByIdPassport(idPassport);
